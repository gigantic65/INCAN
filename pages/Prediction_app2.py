...
def app():
    ...
    st.sidebar.write("<h5 style='text-align: left; color: black;'> 1. 신규 색상 배합 최적화</h5>", unsafe_allow_html=True)

    ques = st.sidebar.radio('최적화 방법',('유사배합 수정설계','신규배합 자동설계', '신규배합 수동설계'))
    ...
    if ques == '유사배합 수정설계':
        ...
        st.write("<h5 style='text-align: left; color: black;'> 1.1 신규 색상배합 - 기존 유사배합 수정설계</h5>", unsafe_allow_html=True)
        ...
        if st.button('Run Prediction',key = count):
            ...
            with col6:
                ...
                st.markdown("<h6 style='text-align: left; color: darkblue;'> 1.1. 유사배합 수정설계 </h6>", unsafe_allow_html=True)
                ...
                st.markdown("<h6 style='text-align: left; color: darkblue;'> ★  최종 신규 수정 조색 배합 </h6>", unsafe_allow_html=True)
                ...
                if para8['Delta_E'][0] < 0.5:
                    st.markdown("<h6 style='text-align: left; color: black;'> 최종 조색 배합이 0.5 보다 낮게 나타남으로 기존배합 수정설계 조색 가능. </h6>", unsafe_allow_html=True)
                    
                else:
                    st.markdown("<h6 style='text-align: left; color: black;'> 최종 조색 배합이 0.5 보다 크게 나타남으로 신규배합 자동설계 조색 필요. </h6>", unsafe_allow_html=True)
    ...
    if ques == '신규배합 자동설계':
        ...
        st.write("<h5 style='text-align: left; color: black;'> 1.2 신규 색상배합 - 신규배합 자동설계</h5>", unsafe_allow_html=True)
        st.markdown("""<hr style="height:2px;border:none; color:rgb(60,90,180); background-color:rgb(60,90,180);"/> """, unsafe_allow_html=True)
    ...
    if ques == '신규배합 수동설계':
        ...
        st.write('')
        st.write("<h5 style='text-align: left; color: black;'> 1.3 신규 색상배합 - 신규배합 수동설계</h5>", unsafe_allow_html=True)
        st.markdown("""<hr style="height:2px;border:none; color:rgb(60,90,180); background-color:rgb(60,90,180);"/> """, unsafe_allow_html=True)
    ...
    st.sidebar.write("<h5 style='text-align: left; color: black;'> 2. 수정 색상 배합 최적화</h5>", unsafe_allow_html=True)
        
  
    #st.markdown("<h6 style='text-align: left; color: darkblue;'> 2.2. 신규 조색제 배합 설계 </h6>", unsafe_allow_html=True)
    
    ques2 = st.sidebar.radio('최적화 방법',('기존배합 수정설계_신규', '기존배합 수정설계_추가'),key=2)
    ...
    if ques2 ==  '기존배합 수정설계_추가' :
        ...
        st.write("<h5 style='text-align: left; color: black;'> 2.2. 수정 색상 배합 설계_추가</h5>", unsafe_allow_html=True)
        st.markdown("""<hr style="height:2px;border:none; color:rgb(60,90,180); background-color:rgb(60,90,180);"/> """, unsafe_allow_html=True)
        ...
        if st.button('Run Prediction', key=11): 
            ...
            with col6:
                ...
                st.markdown("<h6 style='text-align: left; color: darkblue;'> 2.1. 기존배합 수정설계_추가 </h6>", unsafe_allow_html=True)
                ...
                st.markdown("<h6 style='text-align: left; color: darkblue;'> ★ 수정 조색제 배합 </h6>", unsafe_allow_html=True)
